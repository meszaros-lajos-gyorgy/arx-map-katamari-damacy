...
export async function createLevel1(gameState: Entity, settings: Settings): Promise<ArxMap> {
  ...
  const entitySpawns: EntitySpawnProps[] = [
    ...
    { entities: [EntityTypes.Ylside], position: new Vector3(0, 0, 200), size: [70, 100] },
    { entities: [EntityTypes.Ylside], position: new Vector3(0, 0, 300), size: [70, 100] },
    { entities: [EntityTypes.Ylside], position: new Vector3(0, 0, 400), size: [70, 100] },
    { entities: [EntityTypes.Ylside], position: new Vector3(0, 0, 500), size: [70, 100] },
    { entities: [EntityTypes.Ylside], position: new Vector3(0, 0, 600), size: [70, 100] },
    { entities: [EntityTypes.Ylside], position: new Vector3(0, 0, 700), size: [70, 100] },
    { entities: [EntityTypes.Ylside], position: new Vector3(0, 0, 800), size: [70, 100] },

    { entities: [EntityTypes.Ylside], position: new Vector3(-250, 0, 200), size: [70, 100] },
    { entities: [EntityTypes.Ylside], position: new Vector3(-250, 0, 300), size: [70, 100] },
    { entities: [EntityTypes.Ylside], position: new Vector3(-250, 0, 400), size: [70, 100] },
    { entities: [EntityTypes.Ylside], position: new Vector3(-250, 0, 500), size: [70, 100] },
    { entities: [EntityTypes.Ylside], position: new Vector3(-250, 0, 600), size: [70, 100] },
    { entities: [EntityTypes.Ylside], position: new Vector3(-250, 0, 700), size: [70, 100] },
    { entities: [EntityTypes.Ylside], position: new Vector3(-250, 0, 800), size: [70, 100] },

    { entities: [EntityTypes.Ylside], position: new Vector3(-500, 0, 200), size: [70, 100] },
    { entities: [EntityTypes.Ylside], position: new Vector3(-500, 0, 300), size: [70, 100] },
    { entities: [EntityTypes.Ylside], position: new Vector3(-500, 0, 400), size: [70, 100] },
    { entities: [EntityTypes.Ylside], position: new Vector3(-500, 0, 500), size: [70, 100] },
    { entities: [EntityTypes.Ylside], position: new Vector3(-500, 0, 600), size: [70, 100] },
    { entities: [EntityTypes.Ylside], position: new Vector3(-500, 0, 700), size: [70, 100] },
    { entities: [EntityTypes.Ylside], position: new Vector3(-500, 0, 800), size: [70, 100] },

    { entities: [EntityTypes.Ylside], position: new Vector3(-750, 0, 200), size: [70, 100] },
    { entities: [EntityTypes.Ylside], position: new Vector3(-750, 0, 300), size: [70, 100] },
    { entities: [EntityTypes.Ylside], position: new Vector3(-750, 0, 400), size: [70, 100] },
    { entities: [EntityTypes.Ylside], position: new Vector3(-750, 0, 500), size: [70, 100] },
    { entities: [EntityTypes.Ylside], position: new Vector3(-750, 0, 600), size: [70, 100] },
    { entities: [EntityTypes.Ylside], position: new Vector3(-750, 0, 700), size: [70, 100] },
    { entities: [EntityTypes.Ylside], position: new Vector3(-750, 0, 800), size: [70, 100] },
  ]
